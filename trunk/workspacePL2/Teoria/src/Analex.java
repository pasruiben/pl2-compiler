...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("entero", this), new Integer(67));
	literals.put(new ANTLRHashString("si", this), new Integer(39));
	literals.put(new ANTLRHashString("finsi", this), new Integer(42));
	literals.put(new ANTLRHashString("y", this), new Integer(47));
	literals.put(new ANTLRHashString("entonces", this), new Integer(40));
	literals.put(new ANTLRHashString("no", this), new Integer(48));
	literals.put(new ANTLRHashString("modulo", this), new Integer(27));
	literals.put(new ANTLRHashString("clase", this), new Integer(30));
	literals.put(new ANTLRHashString("mientras", this), new Integer(43));
	literals.put(new ANTLRHashString("oculto", this), new Integer(6));
	literals.put(new ANTLRHashString("finmientras", this), new Integer(45));
	literals.put(new ANTLRHashString("falso", this), new Integer(64));
	literals.put(new ANTLRHashString("hacer", this), new Integer(44));
	literals.put(new ANTLRHashString("dev", this), new Integer(36));
	literals.put(new ANTLRHashString("o", this), new Integer(46));
	literals.put(new ANTLRHashString("cierto", this), new Integer(63));
	literals.put(new ANTLRHashString("real", this), new Integer(68));
	literals.put(new ANTLRHashString("sino", this), new Integer(41));
	literals.put(new ANTLRHashString("crear", this), new Integer(72));
	literals.put(new ANTLRHashString("inst", this), new Integer(29));
	literals.put(new ANTLRHashString("formacion", this), new Integer(71));
	literals.put(new ANTLRHashString("logico", this), new Integer(69));
	literals.put(new ANTLRHashString("caracter", this), new Integer(70));
}
			...
			if ((LA(1)=='\r') && (_tokenSet_0.member(LA(2)))) {
				...
				do {
					if ((LA(1)=='\r') && (_tokenSet_0.member(LA(2)))) {
						...
						if ( _cnt1554>=1 ) { break _loop1554; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
			...
			try {
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt1586>=1 ) { break _loop1586; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
		...
		if ( synPredMatched1587 ) {
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt1589>=1 ) { break _loop1589; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt1591>=1 ) { break _loop1591; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			boolean synPredMatched1595 = false;
			if ((((LA(1) >= '0' && LA(1) <= '9')) && (true))) {
				int _m1595 = mark();
				synPredMatched1595 = true;
				inputState.guessing++;
				try {
					{
					{
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '9'))) {
							...
							if ( _cnt1594>=1 ) { break _loop1594; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
					...
					synPredMatched1595 = false;
				}
				rewind(_m1595);
inputState.guessing--;
			}
			if ( synPredMatched1595 ) {
				{
				int _cnt1597=0;
				_loop1597:
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt1597>=1 ) { break _loop1597; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
